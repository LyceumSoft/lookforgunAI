...
dirr = 'C:/Users/Admin/Desktop/icrawler' #путь к папке куда скачивать картинки
lener_mass = []
mass_train = []
dir_mass = []
keywords = ['люди на улице', 'оживленная улица', 'люди в деревне', 'люди в парке', 'шествие по улице москвы'] #список слов по которым будет работать поиск картинки
...
def people_crawl():
    ...
    for i in range(len(keywords)):
        ...
        int_pic_download = 10 #сколько картинок скачается на каждое слово из keywords
